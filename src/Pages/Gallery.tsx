...
import { fetchRandomApods } from '../services/nasa.service';
    ...
    <div className="w-full max-w-6xl mx-auto py-8 px-4 flex flex-col space-y-8">
      ...
      <header className="text-center max-w-2xl mx-auto space-y-3">
        ...
        <p className="text-slate-400 text-sm sm:text-base leading-relaxed">
          Selección de fotografías y descubrimientos astronómicos obtenidos de la base de datos de la NASA. Selecciona cualquier imagen para inspeccionar su ficha técnica.
        </p>
      </header>
      ...
      {error && !loading && (
        <div className="rounded-2xl border border-red-500/30 bg-red-950/30 p-6 text-center flex flex-col items-center space-y-4">
          ...
          <button
            type="button"
            onClick={loadGallery}
            className="min-h-[48px] px-6 py-2 rounded-lg bg-slate-800 hover:bg-slate-700 text-xs font-semibold text-cyan-300 inline-flex items-center space-x-2 transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-400/50"
          >
        ...
        <section aria-label="Cuadrícula de fotografías espaciales" className="space-y-10">
          ...
          <div className="flex justify-center pt-4">
            <button
              ...
              className="min-h-[48px] px-8 py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 hover:text-white border border-slate-700/80 font-semibold text-sm inline-flex items-center space-x-2 transition-all focus:outline-none focus:ring-2 focus:ring-cyan-400/50 disabled:opacity-50"
            >
          ...
          >
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                ...
                className="min-w-[48px] min-h-[48px] w-12 h-12 flex items-center justify-center rounded-lg border border-slate-800 bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-400/50"
              >
              ...
              {selectedItem.hdurl && (
                <div className="pt-2">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="min-h-[48px] px-6 py-3 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-cyan-950 font-bold text-xs inline-flex items-center space-x-2 transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-400/50"
                  >
